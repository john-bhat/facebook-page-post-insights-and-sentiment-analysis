# -*- coding: utf-8 -*-
# Facebook Comments (OI:OPEN INSIGHTS)
# Data Science Team
# John Mohd Bhat
...
file_id="MTNLoaded"
print("comments will be scrapped for MTN NIGERIA")
#access_token = raw_input("Please Paste Your Access Token:")
access_token = settings.get('facebook', 'access_token')
#access_token=access_token = "you page access token"




#===========================================================================#
#              start of comments scrapping                                  #
#===========================================================================#
...
def scrapeFacebookPageFeedComments(page_id, access_token):
    with open(fullpath+'%s_facebook_comments.csv' % file_id, 'wb') as file:
        w = csv.writer(file)
        ...
        with open(fullpath+'%s_facebook_statuses.csv' % file_id, 'rb') as csvfile:
            reader = csv.DictReader(csvfile)

            #reader = [dict(status_id='759985267390294_1158001970921953')]  #test purpose
